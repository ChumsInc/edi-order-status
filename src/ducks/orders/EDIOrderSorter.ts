import {EDIOrder, EDIOrderSort, EDIOrderSorter, EDIOrderSortParams, SortFunction} from "./types";
import {customerKey, orderKey} from "./utils";
...
const sortFields:EDIOrderSort = {
    ...
    ShipExpireDate: (row:EDIOrder) => row.ShipExpireDate,
...
const sortFunctions:EDIOrderSorter = {
    CustomerNo: (a, b) => sortCustomerNo(a, b) || sortCustomerPONo(a, b),
    BillToName: (a, b) => sortBillToName(a, b) || sortCustomerPONo(a, b),
    CustomerPONo: (a,b) => sortCustomerPONo(a, b) || sortCustomerNo(a, b),
    OrderDate: (a,b) => sortOrderDate(a, b) || sortShipExpireDate(a, b) || sortCustomerPONo(a,b),
    ShipExpireDate: (a,b) => sortShipExpireDate(a, b) || sortOrderDate(a, b) || sortCustomerPONo(a,b),
    UDF_CANCEL_DATE: (a,b) => sortUDF_CANCEL_DATE(a, b) || sortOrderDate(a, b) || sortCustomerPONo(a,b),
    OrderCount: (a,b) => (a.OrderCount - b.OrderCount) || sortCustomerPONo(a, b),
    OrderTotal: (a,b) => (a.OrderTotal - b.OrderTotal) || sortCustomerPONo(a, b),
    
}

export const EDIOrderSortHandler = ({list, field, asc}:EDIOrderSortParams):EDIOrder[] => {
